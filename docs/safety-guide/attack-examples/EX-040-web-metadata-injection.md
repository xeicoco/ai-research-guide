...
This is distinct from EX-002 (injection in visible page body text, which a human reviewer would also see) and EX-031 (invisible Unicode within plain text), because the injection occupies a structurally separate channel of the document that humans never encounter during normal browsing.
